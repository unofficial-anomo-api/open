...
imagealphablending($final_img, true);
//header('Content-Type: image/png');
imagepng($final_img, "/avatars/Photo.$username.png");
imagedestroy($final_img);

$urls="https://ws.anomo.com/v210/index.php/webservice/user/update_secret_picture/XLRJXEGJ2UACG7DFT3US";
$post = array("SecretPicture"=>"@/avatars/FullPhoto." . $username . ".png");
$chs = curl_init( $urls );
...
$urls="https://ws.anomo.com/v210/index.php/webservice/user/update_secret_picture/XLRJXEGJ2UACG7DFT3US";
$post = array("SecretPicture"=>"@/avatars/Photo." . $username . ".png");
$chs = curl_init( $urls );
curl_setopt( $chs, CURLOPT_POST, 1);
 curl_setopt ($chs, CURLOPT_POSTFIELDS, $post);
curl_setopt( $chs, CURLOPT_FOLLOWLOCATION, 1);
