...
$url = "http://ws.anomo.com/v210/index.php/webservice/user/get_list_follower/$token/$userid/$page";
//print $url;
...
<p align=\"right\"><a>Follow</a><br>$birthday | $location </p>
</div></div></div>";
