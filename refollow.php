...
$url = "https://ws.anomo.com/v210/index.php/webservice/user/get_list_follower/$token/$userid/1";
$jsonData = file_get_contents($url);
$phpArray2 = json_decode($jsonData);
$pages = $phpArray2->TotalPage;
$page = $phpArray2->CurrentPage;
while ($page <= $pages){
$furl = "https://ws.anomo.com/v210/index.php/webservice/user/get_list_follower/$token/$userid/$page";
...
$numRows = $row['count'];
if ($numRows == "0"){
$fourl = "https://ws.anomo.com/v210/index.php/webservice/user/follow/$token/$fuserid";
